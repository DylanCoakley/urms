        ...
        <div class="row">
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="heading-title text-center">About Us</h2>
            </div>
          </div>
        </div>
        <div class="sub-title">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3">
            <div class="about block text-center">
              <img src="<?php echo base_url(); ?>assets/img/about/img1.png" alt="">
          ...
          <div class="col-sm-6 col-md-3">
            <div class="about block text-center">
              <img src="<?php echo base_url(); ?>assets/img/about/img2.png" alt="">
              <h5><a href="#">About Title</a></h5>
              <p>Quisque sit amet libero purus. Nulla a dignissim quam. In hac habitasse platea dictumst.</p>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="about block text-center">
              <img src="<?php echo base_url(); ?>assets/img/about/img3.png" alt="">
              <h5><a href="#">About Title</a></h5>
              <p>Quisque sit amet libero purus. Nulla a dignissim quam. In hac habitasse platea dictumst.</p>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="about block text-center">
              <img src="<?php echo base_url(); ?>assets/img/about/img4.png" alt="">
              <h5><a href="#">About Title</a></h5>
              <p>Quisque sit amet libero purus. Nulla a dignissim quam. In hac habitasse platea dictumst.</p>
            </div>
          </div>
        ...
        <div id="single-testimonial-item" class="owl-carousel">
          ...
          <div class="item">
            <div class="row justify-content-md-center">
              <div class="col-md-8 col-xs-12 col-md-auto">
                <div class="testimonial-inner text-md-center">
                  ...
                  <div class="testimonial-images">
                    <img class="<?php echo base_url(); ?>assets/img-circle text-md-center" src="img/testimonial/img1.jpg" alt="">
                  </div>
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-8 col-xs-12 col-md-auto">
                <div class="testimonial-inner text-md-center">
                  ...
                  <div class="testimonial-images">
                    <img class="<?php echo base_url(); ?>assets/img-circle text-md-center" src="img/testimonial/img2.jpg" alt="">
                  </div>
                  <div class="testimonial-footer">
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-8 col-xs-12 col-md-auto">
                <div class="testimonial-inner text-md-center">
                  ...
                  <div class="testimonial-images">
                    <img class="<?php echo base_url(); ?>assets/img-circle text-md-center" src="img/testimonial/img3.jpg" alt="">
                  </div>
                  <div class="testimonial-footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-3 text-center">
            ...
            <h3 class="timer" id="websites" data-to="560" data-speed="1000">560</h3>
            <h5 class="fact-title">Happy Clients</h5>
          </div>
          <div class="col-sm-6 col-md-3 text-center">
            <i class="fact-icon fa fa-rocket"></i>
            <h3 class="timer" id="code" data-to="2700" data-speed="1500">2700</h3>
            <h5 class="fact-title">Project Lanched</h5>
          </div>
          <div class="col-sm-6 col-md-3 text-center">
            <i class="fact-icon fa fa-coffee"></i>
            <h3 class="timer" id="coffee" data-to="234" data-speed="2000">234</h3>
            <h5 class="fact-title">Cup of Coffee</h5>
          </div>
          <div class="col-sm-6 col-md-3 text-center">
            <i class="fact-icon fa fa-heart"></i>
            <h3 class="timer" id="emails" data-to="234" data-speed="2500">970</h3>
            <h5 class="fact-title">Peoples Love</h5>
          </div>
        </div>
      </div>
    </section>
