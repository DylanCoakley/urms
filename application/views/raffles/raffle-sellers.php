                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-1 col-form-label" for="val-name">Name</label>
                                            <div class="col-lg-3">
                                                <input type="text" class="form-control" id="val-name" name="val-name" placeholder="Name">
                                            </div>
                                            <label class="col-lg-1 col-form-label" for="val-phone">Phone</label>
                                            <div class="col-lg-3">
                                                <input type="text" class="form-control" id="val-phone" name="val-phone" placeholder="xxx-xxx-xxxx">
                                            </div>
                                        ...
                                        <tbody>
                                            <?php foreach($sellers as $seller) : ?>
                                                <tr>
                                                    ...
                                                    <td contenteditable="false"><?php echo $seller['UserName']; ?></td>
                                                    <td contenteditable="false"><?php echo $seller['Phone']; ?></td>
                                                    <td contenteditable="false"><?php echo $seller['Email']; ?></td>
                                                    <td contenteditable="false"><?php echo $seller['Address']; ?></td>
                                                    <!--<td contenteditable="false">2011/04/25</td>-->
                                                    <td contenteditable="false"><?php echo $seller['AllocatedTickets']; ?></td>
                                                    <td contenteditable="false"></td>
                                                    <td contenteditable="false"><?php echo $seller['Role']; ?></td>
