    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <?php if($this->session->flashdata('insufficient_raffle_tickets')) : ?>
              <?php echo '<p class="alert alert-warning">'.$this->session->flashdata('insufficient_raffle_tickets').'</p>'; ?>
            <?php endif; ?>
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
                                        ...
                                        <tbody>
                                            <?php foreach($requests as $request) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo site_url('/requests/approve/'.$request['RequestID']); ?>" class="btn btn-success">Approve</a></td>
                                                    <td><a href="<?php echo site_url('/requests/decline/'.$request['RequestID']); ?>" class="btn btn-danger">Deny</a></td>
                                                </tr>
                                            <?php endforeach; ?>
