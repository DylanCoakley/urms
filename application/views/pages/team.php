...
<head>
  ...
  <title>Team - Helium Bootstrap 4 UI Kit</title>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="team-members mtb-50">
              <div class="sub-title">
                <span>Team Members #1 / 3 Columns</span>
              </div>
              <div class="row">
                <div class="col-sm-6 col-md-4">
                  ...
                  <div class="team-item">
                    <figure class="team-profile">
                      <img src="<?php echo base_url(); ?>assets/img/team/team-01.jpg" alt="">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <div class="team-item">
                    <figure class="team-profile">
                      <img src="<?php echo base_url(); ?>assets/img/team/team-02.jpg" alt="">
                      <figcaption class="our-team">
                        <div class="details">
                          <p class="content-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                          <hr class="small-divider border-white">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <div class="team-item">
                    <figure class="team-profile">
                      <img src="<?php echo base_url(); ?>assets/img/team/team-03.jpg" alt="">
                      <figcaption class="our-team">
                        <div class="details">
                          <p class="content-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                          <hr class="small-divider border-white">
            ...
            <div class="team-members mtb-50">
              <div class="sub-title">
                <span>Team Members #1 / 4 Columns</span>
              </div>
              <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                  ...
                  <div class="team-item">
                    <figure class="team-profile">
                      <img src="<?php echo base_url(); ?>assets/img/team/team-04.jpg" alt="">
                      <figcaption class="our-team">
                        <div class="details">
                          <p class="content-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                          <hr class="small-divider border-white">
            ...
            <div class="team-members-tow mtb-50">
              <div class="sub-title">
                <span>Team Members #2 / 3 Columns</span>
              </div>
              <div class="row">
                <div class="col-sm-6 col-md-4">
                  <!-- Team Item Starts -->
                  <figure>
                    <img src="<?php echo base_url(); ?>assets/img/team/team-05.jpg" alt="">
                ...
                <div class="col-sm-6 col-md-4">
                  <!-- Team Item Starts -->
                  <figure>
                    <img src="<?php echo base_url(); ?>assets/img/team/team-06.jpg" alt="">
                    <div class="image-overlay">
                      <div class="overlay-text text-center">
                        <div class="info-text">
                ...
                <div class="col-sm-6 col-md-4">
                  <!-- Team Item Starts -->
                  <figure>
                    <img src="<?php echo base_url(); ?>assets/img/team/team-07.jpg" alt="">
                    <div class="image-overlay">
                      <div class="overlay-text text-center">
                        <div class="info-text">
            ...
            <div class="team-members-tow mtb-50">
              <div class="sub-title">
                <span>Team Members #2 / 4 Columns</span>
              </div>
              <div class="row">
                <div class="col-sm-6 col-md-3">
                  <!-- Team Item Starts -->
                ...
                <div class="col-sm-6 col-md-3">
                  <!-- Team Item Starts -->
                  <figure>
                    <img src="<?php echo base_url(); ?>assets/img/team/team-08.jpg" alt="">
                    <div class="image-overlay">
                      <div class="overlay-text text-center">
                        <div class="info-text">
                          <strong>Danny Burton</strong>
