                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-rafflename">Name</label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-rafflename" name="val-rafflename" placeholder="Raffle Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-name">Total Tickets </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Total Tickets">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-raffledes">Description</label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-raffledes" name="val-raffledes" placeholder="Description">
                                            </div>
                                        </div>
                                        <div class="form-group row">
