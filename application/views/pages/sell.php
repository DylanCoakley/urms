      ...
      <nav class="navbar navbar-toggleable-sm navbar-light bg-default" style="margin-bottom:0; padding-bottom:0;">
        <div class="container">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbar1">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="seller">Back</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="row">
          ...
          <div class="card-block">
            ...
            <div class="form-validation">
              <form class="form-valide" action="#" method="post">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="val-email">Phone <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" id="val-email" name="val-email" placeholder="xxx-xxx-xxxx">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="val-email">Address</label>
                    <div class="col-lg-9">
      ...
      <div class="col-lg-5">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-block">
              <h3 class="card-title m-t-15">Confirm</h3>
              <div class="form-validation">
                <form class="form-valide" action="#" method="post">
