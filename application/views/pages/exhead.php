        ...
        <div class="row">
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="heading-title text-center">Headers</h2>
            </div>
            <div class="sub-title">
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="services.html">Item 1</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="sliders.html">Item 2</a>
                  </li>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6">
              <div class="hero-content-v2">
                <h3>HELIUM <strong>Bootstrap 4 UI Kit</strong></h3>
                <p> Lorem ipsum dolor sit amet, consectetuer adipiscing elit Lorem ipsum dolor sit amet, consectetuer
                </p>
                <a href="#" class="page-scroll btn btn-lg btn-default-filled">Learn More</a>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6">
              <figure>
                <img src="<?php echo base_url(); ?>assets/img/bg/hero-1.png" alt="">
              </figure>
            </div>
      ...
      <div class="header-style-3">
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-6">
              <figure>
                <img src="<?php echo base_url(); ?>assets/img/bg/hero-2.png" alt="">
              </figure>
            </div>
            <div class="col-xs-12 col-sm-6">
              <div class="hero-content-v2">
