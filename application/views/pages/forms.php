...
<head>
  ...
  <title>Forms - Helium Bootstrap 4 UI Kit</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="heading-title text-center">Forms</h2>
            </div>
            <!-- contact forms -->
              ...
              <form id="contactForm" data-toggle="validator">
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <button type="submit" id="form-submit" class="btn btn-md btn-common btn-form-submit">Send Message</button>
            ...
            <!-- log forms -->
            <h4 class="sub-title">Login / Register Forms</h4>
            <!-- form 1 -->
            <div class="row">
              <!-- Start login form  -->
              <div class="col-md-6 col-sm-12 col-xs-12">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div id="register-form">
                  ...
                  <div class="log-line reg-form-1 no-margin">
                    ...
                    <div class="pull-right">
                      <button type="submit" id="reg-submit" class="btn btn-md btn-common btn-log">Register</button>
                      <div id="msgSubmit" class="h3 text-center hidden"></div>
                      <div class="clearfix"></div>
                    </div>
                  </div>
                  ...
                  <div class="log-line">
                    <div class="pull-left">
                      <div class="checkbox checkbox-primary space-bottom">
                        ...
                        <label for="checkbox3"><span>Remember Me</span></label>
                      </div>
                    </div>
                  </div>

                  <div>
                    <button type="submit" id="log-submit" class="btn btn-filled btn-log margin-right"><i class="fa fa-sign-in"></i> <span>Log In</span></button></br>
                    <button type="button" class="btn-social btn-facebook-filled btn-log margin-right"><i class="fa fa-facebook"></i> <span>Log In with Facebook</span></button>
                    <button type="button" class="btn-social btn-twitter-filled btn-log margin-right"><i class="fa fa-twitter"></i> <span>Log In with Twitter</span></button>
                  </div>
                  <div>
                    <a href="#" class="forgot-password">Forgot your Password?</a>
                  </div>
                  ...
                  <div class="log-line">
                    <div class="pull-left">
                      <div class="checkbox checkbox-primary space-bottom">
                        ...
                        <label for="checkbox4"><span><a href="#">Terms & Conditions</a></span></label>
                      </div>
                    </div>
                  </div>

                  <div>
                    <button type="submit" id="reg-submit" class="btn btn-filled btn-log margin-right"><i class="fa fa-sign-in"></i> <span>Register</span></button></br>
                    ...
                    <button type="button" class="btn-social btn-twitter-filled btn-log margin-right"><i class="fa fa-twitter"></i> <span>Register with Twitter</span></button>
                  </div>
                </div>
              </div>
            </div>
